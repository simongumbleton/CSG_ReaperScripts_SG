...
#Input variables. TO DO: Drive these from data e.g Reaper
    ...
    def onJoin(self, details):
        ...
        def onParentSelected(objects):
            ...
            if not MyComponent.parentSelected:
                ...
                if MyComponent.OPTION_CreateEvent:
                    ...
                    RPR_ShowMessageBox(" Finished ", " WWISE ", 0)
        ...
        #RPR_ShowConsoleMsg("Select object in Wwise")



        type = RPR_GetUserInputs('Dialog Box', 1, 'Enter desired object type', '', 32)
        name = RPR_GetUserInputs('Dialog Box', 1, 'Enter desired name', '', 32)
        RPR_ShowMessageBox(str(type[4] + " " + str(name[4])), " WWISE ", 0)

        MyComponent.INPUT_ObjectType = str(type[4])
        MyComponent.INPUT_ObjectName = str(name[4])

        RPR_ShowMessageBox("select parent in wwise ", " WWISE ", 0)

    def onDisconnect(self):
        print("The client was disconnected.")
        #RPR_ShowConsoleMsg("Finished")
